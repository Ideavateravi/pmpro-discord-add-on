...
$member_discord_redirect_to_discord_server    = sanitize_text_field( trim( get_option( 'ets_pmpro_discord_redirect_to_discord_server' ) ) );
...
<?php wp_nonce_field( 'save_discord_adv_settings', 'ets_discord_save_adv_settings' ); ?>
  <table class="form-table" role="presentation">
	<tbody>
  <tr>
		<th scope="row"><?php esc_html_e( 'Shortcode', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
		[discord_connect_button]
	<br/>
	<small><?php esc_html_e( ' Using the shortcode [discord_connect_button] on any page, anyone can join the website discord server by authentication via member discord account. New members will get default role if selected in the setting.', 'pmpro-discord-add-on' ); ?></small>
		</fieldset></td>
	  </tr>
  <tr>
		<th scope="row"><?php esc_html_e( 'Use rich embed messaging feature?', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		...
		?>
		 value="1">
				<br/>
				<small><?php esc_html_e( 'By checking this box, you are indicating that you want to delete all data associated with the plugin when it is uninstalled.', 'pmpro-discord-add-on' ); ?></small>                
		</fieldset></td>
	  </tr>	          
  <tr>
		<th scope="row"><?php esc_html_e( 'Send welcome message', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Membership welcome message', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
		<textarea class="ets_pmpro_discord_dm_textarea" name="ets_pmpro_discord_welcome_message" id="ets_pmpro_discord_welcome_message" row="25" cols="50">
		<?php
		if ( $ets_pmpro_discord_welcome_message ) {
			echo wp_unslash( trim( $ets_pmpro_discord_welcome_message ) ); }
		?>
		</textarea> 
	<br/>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Send membership expiration warning message', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Membership expiration warning message', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
		<textarea  class="ets_pmpro_discord_dm_textarea" name="ets_pmpro_discord_expiration_warning_message" id="ets_pmpro_discord_expiration_warning_message" row="25" cols="50">
		<?php
		if ( $ets_pmpro_discord_expiration_warning_message ) {
			echo wp_unslash( $ets_pmpro_discord_expiration_warning_message ); }
		?>
		</textarea> 
	<br/>
	<small>Merge fields: [MEMBER_USERNAME], [MEMBER_EMAIL], [MEMBERSHIP_LEVEL], [SITE_URL], [BLOG_NAME], [MEMBERSHIP_ENDDATE], [MEMBERSHIP_STARTDATE]</small>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Send membership expired message', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Membership expired message', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
		<textarea  class="ets_pmpro_discord_dm_textarea" name="ets_pmpro_discord_expiration_expired_message" id="ets_pmpro_discord_expiration_expired_message" row="25" cols="50">
		<?php
		if ( $ets_pmpro_discord_expiration_expired_message ) {
			echo wp_unslash( $ets_pmpro_discord_expiration_expired_message ); }
		?>
		</textarea> 
	<br/>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Send membership cancel message', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
		...
		<tr>
		<th scope="row"><?php esc_html_e( 'Membership cancel message', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
		<textarea  class="ets_pmpro_discord_dm_textarea" name="ets_pmpro_discord_cancel_message" id="ets_pmpro_discord_cancel_message" row="25" cols="50">
		<?php
		if ( $ets_pmpro_discord_cancel_message ) {
			echo wp_unslash( $ets_pmpro_discord_cancel_message ); }
		?>
		</textarea> 
	<br/>
	<small>Merge fields: [MEMBER_USERNAME], [MEMBER_EMAIL], [MEMBERSHIP_LEVEL], [SITE_URL], [BLOG_NAME]</small>
  ...
  <tr>
		<th scope="row"><?php esc_html_e( 'Re-assign roles upon payment failure', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php esc_html_e( 'Retry Failed API calls', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php esc_html_e( 'Kick members out when they Disconnect their Account?', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<small>Members will be kicked out if this setting is checked.</small>
	  ...
	  <tr>
		<th scope="row"><?php esc_html_e( 'Force Discord Authentication before checkout', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php esc_html_e( 'Login with Discord on checkout Page', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<small><?php esc_html_e( 'A new account will be created if the discord account E-mail is not exist into the system.', 'pmpro-discord-add-on' ); ?></small>
  </td>
	  </tr>
	  <tr>
		<th scope="row"><?php esc_html_e( 'Redirect member to connected discord server', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
		<input name="member_discord_redirect_to_discord_server" type="checkbox" id="member_discord_redirect_to_discord_server" 
		<?php
		if ( $member_discord_redirect_to_discord_server == true ) {
			echo 'checked="checked"'; }
		?>
		 value="1">
		</fieldset>
	<small><?php esc_html_e( 'If checked, this will redirect member to connected discord server.', 'pmpro-discord-add-on' ); ?></small>
  </td>
	  </tr>

	  <tr>
		<th scope="row"><?php esc_html_e( 'How many times a failed API call should get re-try', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
		<input name="ets_pmpro_retry_api_count" type="number" min="1" id="ets_pmpro_retry_api_count" value="
		<?php
	  ...
	  <tr>
		<th scope="row"><?php esc_html_e( 'Set job queue concurrency', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	  ...
	  <tr>
		<th scope="row"><?php esc_html_e( 'Set job queue batch size', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
	...
	<tr>
		<th scope="row"><?php esc_html_e( 'Log API calls response (For debugging purpose)', 'pmpro-discord-add-on' ); ?></th>
		<td> <fieldset>
  ...
  <div class="bottom-btn">
	<button type="submit" name="adv_submit" value="ets_submit" class="ets-submit ets-bg-green">
	  <?php esc_html_e( 'Save Settings', 'pmpro-discord-add-on' ); ?>
	</button>
  </div>
</form>
